...
class VisitorManagerTest extends TestCase
{
    ...
    public function test_manager_can_detect_visitor_without_languages(): void
    {
        $visitor = $this->app->make(VisitorManager::class)->from(
            ip: '8.8.8.8',
        ...
        $this->assertNull($visitor->language()->language());
        $this->assertSame([], $visitor->language()->languages());
    }

    public function test_manager_can_accept_language_contract(): void
    {
        $visitor = $this->app->make(VisitorManager::class)->from(
            ip: '8.8.8.8',
            userAgent: 'UnitTest/1.0',
        ...
        $this->assertSame('en', $visitor->language()->language());
        $this->assertSame(['en', 'de'], $visitor->language()->languages());
    }
}
